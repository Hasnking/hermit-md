...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '07_16_H_E_R_M_I_T_4KI3DFV',
    ...
    ANTILINK_MSG: process.env.ANTILINK_MSG || '_Link Not Allowed!_\n_(Change this by setting var ANTILINK_MSG by prince HACKER)_',
    BOT_INFO: process.env.BOT_INFO || 'prince;923168598809;https://i.imgur.com/MWjUXcJ.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'prince;https://i.imgur.com/MWjUXcJ.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'prince' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '923168598809',
       DEBUG: DEBUG
};
